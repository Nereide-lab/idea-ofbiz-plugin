...
class OfbizJavaPatterns {
    ...
    public static final PsiElementPattern ENTITY_CALL = psiElement().andOr(
            makeDelegatorJavaMethodParameterPattern('clearCacheLine', 0),
            makeDelegatorJavaMethodParameterPattern('clearCacheLineByCondition', 0),
            makeDelegatorJavaMethodParameterPattern('create', 0),
            makeDelegatorJavaMethodParameterPattern('createSingle', 0),
            makeDelegatorJavaMethodParameterPattern('find', 0),
            makeDelegatorJavaMethodParameterPattern('findAll', 0),
            makeDelegatorJavaMethodParameterPattern('findByAnd', 0),
            ...
            makeDelegatorJavaMethodParameterPattern('getEntityGroupName', 0),
            makeDelegatorJavaMethodParameterPattern('getEntityHelper', 0),
            makeDelegatorJavaMethodParameterPattern('getEntityHelperName', 0),
            makeDelegatorJavaMethodParameterPattern('getModelEntity', 0),
            makeDelegatorJavaMethodParameterPattern('makeValidValue', 0),
            makeDelegatorJavaMethodParameterPattern('makeValue', 0),
            makeDelegatorJavaMethodParameterPattern('makeValueSingle', 0),
            makeDelegatorJavaMethodParameterPattern('removeAll', 0),
            makeDelegatorJavaMethodParameterPattern('removeByAnd', 0),
            makeDelegatorJavaMethodParameterPattern('removeByCondition', 0),
            makeDelegatorJavaMethodParameterPattern('storeByCondition ', 0),
