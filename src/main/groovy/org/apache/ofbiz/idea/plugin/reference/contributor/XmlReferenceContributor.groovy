...
import org.apache.ofbiz.idea.plugin.reference.xml.provider.DatasourceReferenceProvider
import org.apache.ofbiz.idea.plugin.reference.xml.provider.FileReferenceProvider
import org.apache.ofbiz.idea.plugin.reference.xml.provider.FormReferenceProvider
import org.apache.ofbiz.idea.plugin.reference.xml.provider.GridReferenceProvider
import org.apache.ofbiz.idea.plugin.reference.xml.provider.GroovyServiceMethodReferenceProvider
import org.apache.ofbiz.idea.plugin.reference.xml.provider.JavaMethodReferenceProvider
import org.apache.ofbiz.idea.plugin.reference.xml.provider.MenuReferenceProvider
import org.apache.ofbiz.idea.plugin.reference.xml.provider.RequestMapReferenceProvider
import org.apache.ofbiz.idea.plugin.reference.xml.provider.ScreenReferenceProvider
import org.apache.ofbiz.idea.plugin.reference.xml.provider.ViewMapReferenceProvider
