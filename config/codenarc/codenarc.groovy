...
//    CompileStatic // Kind of unproductive for groovy isn't it ?
    ConfusingTernary
    CouldBeElvis
...
//    Instanceof
    ...
    // SpaceAfterOpeningBrace todo setup settings
    SpaceAfterSemicolon
    SpaceAfterSwitch
    SpaceAfterWhile
    ...
    SpaceAroundOperator
    // SpaceBeforeClosingBrace todo setup settings
    ...
    GroovyLangImmutable
//    UseCollectMany TODO see if possible
    UseCollectNested
    ...
    // rulesets/size.xml
//    AbcMetric  TODO  Can't find the doc at the moment
    ClassSize
...
//    UnnecessaryReturnKeyword // this one makes code less clear IMO
